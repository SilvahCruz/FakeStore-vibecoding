...
class Database {
    ...
    public function getConnection() {
        ...
        try {
            ...
            // Não exibir erro para não quebrar o layout
            // Apenos retorna null se não conseguir conectar
            $this->conn = null;
        }
        return $this->conn;
    }
...
function criarTabelas($db) {
    // Verificar se a conexão é válida antes de tentar criar tabelas
    if ($db === null) {
        return false;
    }
...
try {
    ...
    // Só tenta criar tabelas se a conexão for bem-sucedida
    if ($db !== null) {
        criarTabelas($db);
    }
} catch(Exception $e) {
